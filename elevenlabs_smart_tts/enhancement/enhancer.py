...
class TextEnhancer:
    ...
    def enhance(
        ...
        self._validate_word_preservation(text, enhanced)
    ...
    def _validate_word_preservation(self, original: str, enhanced: str) -> None:
        original_semantic = self._semantic_words(original)
        enhanced_semantic = self._semantic_words(enhanced)
        ratio = self._preserved_word_ratio(original_semantic, enhanced_semantic)
    ...
    @staticmethod
    def _preserved_word_ratio(original_words: list[str], enhanced_words: list[str]) -> float:
    ...
    def _semantic_words(self, text: str) -> list[str]:
        return [
            word
            for word in self._extract_words(text)
            if not self._is_skippable_token(word)
        ]
